...
bool day2__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("day2.msg._robot_status.RobotStatus", full_classname_dest, 34) == 0);
  }
  day2__msg__RobotStatus * ros_message = _ros_message;
  {  // robot_name
  ...
  {  // sensor_status
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      bool * dest = ros_message->sensor_status.data;
  ...
  {  // task_progress
    ...
    assert(PyFloat_Check(field));
    ros_message->task_progress = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // error_message
...
PyObject * day2__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("day2.msg._robot_status");
  ...
  {  // sensor_status
    ...
    bool * src = ros_message->sensor_status.data;
  ...
  {  // task_progress
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->task_progress);
    {
