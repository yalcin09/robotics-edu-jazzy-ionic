...
bool repeat_1_4__msg__position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("repeat_1_4.msg._position.Position", full_classname_dest, 33) == 0);
  }
  repeat_1_4__msg__Position * ros_message = _ros_message;
  {  // x
...
PyObject * repeat_1_4__msg__position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("repeat_1_4.msg._position");
