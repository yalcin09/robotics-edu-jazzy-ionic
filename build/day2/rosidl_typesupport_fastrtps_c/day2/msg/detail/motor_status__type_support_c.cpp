...
#include "day2/msg/detail/motor_status__rosidl_typesupport_fastrtps_c.h"
...
using _MotorStatus__ros_msg_type = day2__msg__MotorStatus;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pid_output
  {
    cdr << ros_message->pid_output;
  }

  // Field name: total_revolutions
  {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = day2__msg__MotorStatus;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const day2__msg__MotorStatus * ros_message = static_cast<const day2__msg__MotorStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_day2__msg__MotorStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  day2__msg__MotorStatus * ros_message = static_cast<day2__msg__MotorStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_day2__msg__MotorStatus(cdr, ros_message);
}

static uint32_t _MotorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_day2__msg__MotorStatus(
...
static size_t _MotorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_day2__msg__MotorStatus(
