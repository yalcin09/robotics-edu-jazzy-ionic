...
#ifndef DAY2__SRV__DETAIL__CALCULATE_PATH__FUNCTIONS_H_
#define DAY2__SRV__DETAIL__CALCULATE_PATH__FUNCTIONS_H_
...
/// Initialize srv/CalculatePath message.
/**
 ...
 * )) before or use
 * day2__srv__CalculatePath_Request__create()
...
/// Finalize srv/CalculatePath message.
/**
...
/// Create srv/CalculatePath message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * day2__srv__CalculatePath_Request__init().
...
/// Destroy srv/CalculatePath message.
/**
 * It calls
 * day2__srv__CalculatePath_Request__fini()
...
/// Check for srv/CalculatePath message equality.
/**
...
/// Copy a srv/CalculatePath message.
/**
...
/// Initialize array of srv/CalculatePath messages.
/**
...
/// Finalize array of srv/CalculatePath messages.
/**
 * It calls
 * day2__srv__CalculatePath_Request__fini()
...
/// Create array of srv/CalculatePath messages.
/**
...
/// Destroy array of srv/CalculatePath messages.
/**
 * It calls
 * day2__srv__CalculatePath_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CalculatePath message array equality.
/**
...
/// Copy an array of srv/CalculatePath messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * day2__srv__CalculatePath_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_day2
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * day2__srv__CalculatePath_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_day2
...
/**
 * It calls
 * day2__srv__CalculatePath_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_day2
...
/**
 * It calls
 * day2__srv__CalculatePath_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * day2__srv__CalculatePath_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_day2
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * day2__srv__CalculatePath_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_day2
...
/**
 * It calls
 * day2__srv__CalculatePath_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_day2
...
/**
 * It allocates the memory for the array and calls
 * day2__srv__CalculatePath_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_day2
...
/**
 * It calls
 * day2__srv__CalculatePath_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DAY2__SRV__DETAIL__CALCULATE_PATH__FUNCTIONS_H_
