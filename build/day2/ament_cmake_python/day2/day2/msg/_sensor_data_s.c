...
bool day2__msg__sensor_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("day2.msg._sensor_data.SensorData", full_classname_dest, 32) == 0);
  }
  day2__msg__SensorData * ros_message = _ros_message;
  {  // header
  ...
  {  // sensor_id
    ...
    ros_message->sensor_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // values
  ...
  {  // value_names
    PyObject * field = PyObject_GetAttrString(_pymsg, "value_names");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'value_names'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->value_names.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // accuracy
    ...
    ros_message->accuracy = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // error_code
...
PyObject * day2__msg__sensor_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("day2.msg._sensor_data");
  ...
  {  // value_names
    ...
    rosidl_runtime_c__String * src = ros_message->value_names.data;
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "value_names", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // accuracy
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->accuracy);
    {
